...
if [ -z $predict_say ] || [ -z $capt_dir ]; then
	echo "local/compute_capt_accuracy_e2e.sh --should_say data/test_l2_should_say/text --actual_say data/test_l2/text --predict_say exp/train_pytorch/decode_test_l2/hyp --capt-dir exp/train_pytorch/decode_test_l2/capt"
	exit 0;
fi

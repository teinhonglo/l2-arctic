...
$cmd JOB=1:$nj $dir/log/gop.JOB.log \
  compute-dnn-bi-gop --use-gpu=no --online-ivectors=$ivectors \
                    $dir/tree $dir/final.mdl $lang/L.fst \
                    "$feats" "$tra" "ark,t:$dir/gop.JOB" \
                    "ark,t:$dir/align.JOB" "ark,t:$dir/phoneme_ll.JOB" $srcdir/phones.txt || exit 1;
...
for n in $(seq $nj); do
  cat $dir/phone.$n.ctm || exit 1;
done > $dir/phone.ctm || exit 1;
